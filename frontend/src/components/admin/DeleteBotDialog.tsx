    ...
    >
      ...
      >
        <div className="flex items-center gap-3 mb-4">
          ...
          <h2 className="font-semibold text-white">Delete bot?</h2>
        </div>
        <p className="text-sm text-[#8a8a8f] mb-6">
          <span className="text-white font-medium">&ldquo;{botName}&rdquo;</span> and all its
          assigned LLM configs will be permanently deleted. This cannot be undone.
        </p>
